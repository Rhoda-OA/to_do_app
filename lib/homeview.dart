  ...
  Widget build(BuildContext context) {
   ...
   appBar: AppBar(
        ...
        title: const Text(
          ...
          fontSize: 21, color:  Color.fromRGBO(37, 43, 103, 1)),
        ), 
       leading: const Center(
            child: Padding(
              ...
              child: CircleAvatar(
                      radius: 70,
                       backgroundImage: NetworkImage('https://images.unsplash.com/photo-1619895862022-09114b41f16f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cHJvZmlsZSUyMHBpY3R1cmV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60'),
                    ),
            )),   
     actions: [
